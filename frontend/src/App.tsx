...
const DetailDrawer: React.FC<DetailDrawerProps> = ({ recipe, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-blue-950/65 flex items-center justify-center">
            <div className="relative w-full max-w-lg bg-white rounded-lg shadow-lg overflow-y-auto max-h-[90vh]">
